...
import {
  ...
  discreteUpdates,
  flushSync
} from '../react-imgui-reconciler/reconciler.js';
import StyleSheet from './StyleSheet.js';
export { default as Platform } from './Platform.js';
export { default as Dimensions, useWindowDimensions } from './Dimensions.js';
export { default as Appearance, useColorScheme, getColorScheme } from './Appearance.js';
...
function createPrimitiveComponent(type) {
  ...
  const Component = function ImguiPrimitive(props = {}) {
    ...
    const finalProps = resolvedStyle !== undefined
...
export const DemoWindow = createPrimitiveComponent('demowindow');
...
export const Tree = createPrimitiveComponent('tree');
export const TreeNode = createPrimitiveComponent('treenode');
export const TabBar = createPrimitiveComponent('tabbar');
export const TabItem = createPrimitiveComponent('tabitem');
...
export const InputTextMultiline = createPrimitiveComponent('inputtextmultiline');
export const InputFloat = createPrimitiveComponent('inputfloat');
export const InputInt = createPrimitiveComponent('inputint');
export const InputDouble = createPrimitiveComponent('inputdouble');
export const InputScalar = createPrimitiveComponent('inputscalar');
...
export const ListBox = createPrimitiveComponent('listbox');
export const Image = createPrimitiveComponent('image');
export const ImageButton = createPrimitiveComponent('imagebutton');
export const PlotLines = createPrimitiveComponent('plotlines');
export const PlotHistogram = createPrimitiveComponent('plothistogram');
export const Tooltip = createPrimitiveComponent('tooltip');
export const Popup = createPrimitiveComponent('popup');
export const PopupModal = createPrimitiveComponent('popupmodal');
export const DockSpace = createPrimitiveComponent('dockspace');

export { createRoot, render, batchedUpdates, discreteUpdates, flushSync, StyleSheet };
