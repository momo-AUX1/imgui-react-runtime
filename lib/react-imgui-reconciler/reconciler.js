...
if (typeof globalThis === 'object' && globalThis !== null) {
  if (typeof reconciler.batchedUpdates === 'function') {
    globalThis.__reactImguiBatchedUpdates = reconciler.batchedUpdates.bind(reconciler);
  }
  if (typeof reconciler.discreteUpdates === 'function') {
    globalThis.__reactImguiDiscreteUpdates = reconciler.discreteUpdates.bind(reconciler);
  }
  if (typeof reconciler.flushSync === 'function') {
    globalThis.__reactImguiFlushSync = reconciler.flushSync.bind(reconciler);
  }
}
...
export const batchedUpdates = (...args) => reconciler.batchedUpdates(...args);
export const discreteUpdates = (...args) => reconciler.discreteUpdates(...args);
export const flushSync = (...args) => reconciler.flushSync(...args);
